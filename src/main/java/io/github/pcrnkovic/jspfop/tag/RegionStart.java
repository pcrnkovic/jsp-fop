 ...
 * @author Pavle
 */
public class RegionStart extends AbstractFopTag implements 
        Rendered, CommonBorderPaddingBackgroundProperties, Clip, DisplayAlign, Extent, Overflow, RegionName, ReferenceOrientation, WritingMode {

    public RegionStart() {
        super("region-start", true);
    }
