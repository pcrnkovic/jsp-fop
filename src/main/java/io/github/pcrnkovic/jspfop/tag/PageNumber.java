 ...
 */
public class PageNumber extends AbstractFopTag implements io.github.pcrnkovic.jspfop.tag.group.Inline, 
        ...
        CommonRelativePositionProperties, AlignmentAdjust, AlignmentBaseline, BaselineShift, DominantBaseline, Id, IndexClass, IndexKey, KeepWithNext, KeepWithPrevious, 
        LetterSpacing, LineHeight, ScoreSpaces, TextAltitude, TextDecoration, TextDepth, TextShadow, TextTransform, Visibility, WordSpacing, WrapOption{

    public PageNumber() {
        super("page-number", true);
    }
