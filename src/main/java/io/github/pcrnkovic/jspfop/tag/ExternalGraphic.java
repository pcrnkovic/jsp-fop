...
public class ExternalGraphic extends AbstractFopTag implements io.github.pcrnkovic.jspfop.tag.group.Inline,
        ...
        DisplayAlign, DominantBaseline, Height, Id, IndexClass, IndexKey, InlineProgressionDimension, KeepWithNext, KeepWithPrevious, LineHeight, Overflow, 
        Scaling, ScalingMethod, Src, TextAlign, Width {

    public ExternalGraphic() {
        super("external-graphic", true);
    }
