...
public class PageNumberCitation extends AbstractFopTag implements Rendered, io.github.pcrnkovic.jspfop.tag.group.Inline, 
        ...
        CommonRelativePositionProperties, AlignmentAdjust, AlignmentBaseline, BaselineShift, DominantBaseline, Id, IndexClass, IndexKey, 
        KeepWithNext, KeepWithPrevious, LetterSpacing, LineHeight, RefId, ScoreSpaces, TextAltitude, TextDecoration, TextDepth, TextShadow, TextTransform, 
        Visibility, WordSpacing, WrapOption {

    public PageNumberCitation() {
        super("page-number-citation", true);
    }
