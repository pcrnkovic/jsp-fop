...
import io.github.pcrnkovic.jspfop.attr.Precedence;
 ...
 * @author Pavle
 */
public class RegionBefore extends AbstractFopTag implements 
        Rendered, CommonBorderPaddingBackgroundProperties, Clip, DisplayAlign, Extent, Overflow, Precedence, RegionName, ReferenceOrientation, WritingMode{

    public RegionBefore() {
        super("region-before", true);
    }
